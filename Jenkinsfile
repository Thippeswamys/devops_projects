pipeline {
    ...
    environment {
        ...
        AWS_DEFAULT_REGION = 'us-east-1' // Replace with your chosen region
    ...
    stages {
        ...
        stage('Test App') {
            steps {
                echo 'Testing Python local output...'
                sh 'python3 app.py'
            }
        }
